<%-- 
    Document   : admintab3
    Created on : Jan 17, 2020, 12:03:11 PM
    Author     : USER
--%>
...
<!-- Trigger the modal with a button -->
    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#nonconsumModal">ADD ITEM</button>
</center>
</div>
<!-- Modal -->  
<div id="nonconsumModal" class="modal fade" role="dialog">
...
<form action="nonconsumable" method="post">
...
<tbody>
    <tr>
    <td>Item Name:</td>
    <td><input type="text" name="iname" required  class="form-control"></td>
    </tr>
    <tr>
    ...
    <tr>
    <td>Serial Number:</td>
    <td><input type="text" name="sn" required class="form-control"></td>
    </tr>        
</tbody>
</table>        
<div class="modal-footer"> 
    <button class="btn btn-primary btn-lg px-3"  type="button" data-dismiss="modal">Cancel</button>
    <button class="btn btn-primary btn-lg px-3" type="submit" name="noncon">Submit</button>
</div>
</form>
</div>
</div> 
