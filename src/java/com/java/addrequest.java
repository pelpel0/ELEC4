...
@WebServlet(name = "addrequest", urlPatterns = {"/addrequest"})
     ...
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         try{
            ...
            if (request.getParameter("Addrequest")!=null)
            {
                ...
                String sql1="insert into request(name, lname, studentnumber, course, year, section, email, date, time,requestdetails , approval, user) values('"+name+"','"+lname+"','"+studentnumber+"','"+course+"','"+year+"','"+section+"','"+email+"','"+Date+"','"+time+"','"+requestdetails+"','"+approval+"','"+user1+"')";             
