...
<div class="modal-footer"> 
    ...
    <button class=" btn btn-lg btn-secondary px-3" type="submit" name="ADD">Submit</button>
</div> 
...
<div class="modal-footer" style="margin-top: 50px; "> 
    ...
    <button class="btn btn-primary btn-lg px-2 "  type="button" data-dismiss="modal">Cancel</button>
    <button class="btn btn-primary btn-lg px-2"   type="submit" name="Addrequest">Submit</button>
</div>
</div>
</div>
</form>
...
<table class="blueTable" style="height: 188px;" width="340">
    ...
    <%
        try {   
            ...
            Connection con = DB.getConnection();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("select * from request where user ='"+username+"'");
            while (rs.next()) {
        %>
        <tr>
